...
GRANT SELECT ON DATABASE raw TO ROLE dev_role;
GRANT SELECT ON SCHEMA raw.public TO ROLE dev_role;
...
GRANT SELECT ON SCHEMA raw.yelp TO ROLE dev_role;
...
GRANT SELECT ON FUTURE SCHEMAS IN DATABASE raw TO ROLE dev_role;
GRANT SELECT ON ALL VIEWS IN DATABASE RAW TO ROLE ci_role;
GRANT SELECT ON FUTURE VIEWS IN DATABASE RAW TO ROLE ci_role;

GRANT SELECT ON DATABASE raw TO ROLE ci_role;
GRANT SELECT ON SCHEMA raw.public TO ROLE ci_role;
...
GRANT SELECT ON SCHEMA raw.yelp TO ROLE ci_role;
...
GRANT SELECT ON FUTURE SCHEMAS IN DATABASE raw TO ROLE ci_role;
GRANT SELECT ON ALL VIEWS IN DATABASE RAW TO ROLE ci_role;
GRANT SELECT ON FUTURE VIEWS IN DATABASE RAW TO ROLE ci_role;
